...
import { initAdmin, checkAdminAccess, openAdminPanel } from './modules/admin.js';
...
// --- DOM refs ---
  ...
  // --- Admin panel (multi-user mode) ---
  var isMultiUserMode = false;
  initAdmin({
    get projectList() { return cachedProjects; },
  });
  // Add admin button to user island if user is admin
  // checkAdminAccess fetches /api/me which returns multiUser flag
