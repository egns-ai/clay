...
// Pane root captured on first ensurePanel call
var paneRoot = null;
...
function ensurePanel() {
  ...
  paneRoot = ctx.messagesEl ? ctx.messagesEl.closest(".pane") : null;
  var appEl = paneRoot ? paneRoot.querySelector(".pane-app") : document.querySelector(".pane-app");
  if (!appEl) return;
...
function openScheduler() {
  ...
  var inputArea = (paneRoot || document).querySelector(".pane-input-area");
  var titleBar = (paneRoot || document).querySelector(".pane > .title-bar-content");
  var notesContainer = (paneRoot || document).querySelector(".pane-sticky-notes-container");
