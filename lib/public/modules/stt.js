...
// Whisper hallucination patterns — non-speech artifacts the model generates
var HALLUCINATION_RE = /^\s*[\[\(（【].*[\]\)）】]\s*$/;

function isHallucination(text) {
  // Filter bracketed non-speech: [laughter], (keyboard clicking), [더 맛있게 먹으러 가자], etc.
  return HALLUCINATION_RE.test(text);
}
