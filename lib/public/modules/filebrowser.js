...
// Shared caches at module level (safe for concurrent reads)
var gitDiffCache = {};       // hash -> diff text
var fileAtCache = {};        // hash -> file content

export function createFileBrowserInstance(_ctx) {
  var ctx = _ctx;
  ...
  function renderBody() {
    var bodyEl = document.querySelector(".pane-file-viewer-body");
    var renderBtn = document.querySelector(".pane-file-viewer-render");
    var pdfBtn = document.querySelector(".pane-file-viewer-pdf");
  ...
  function refreshIfOpen(filePath) {
  ...
  function showFileContent(msg) {
    var pathEl = document.querySelector(".pane-file-viewer-path");
    var bodyEl = document.querySelector(".pane-file-viewer-body");
    var renderBtn = document.querySelector(".pane-file-viewer-render");
    ...
    renderBtn.classList.remove("active");
    document.querySelector(".pane-file-viewer-pdf").classList.add("hidden");
    ...
    if (pendingOpenMode && pendingOpenMode.type === "diff" && currentContent != null) {
      ...
      selectedEntries = [];
      currentHistoryEntries = [];
      var historyBtn2 = document.querySelector(".pane-file-viewer-history");
    ...
    if (!keepRenderState) {
      ...
      selectedEntries = [];
      currentHistoryEntries = [];
      var historyBtn = document.querySelector(".pane-file-viewer-history");
  ...
  function handleFileHistory(msg) {
  ...
  // Close button
  document.querySelector(".pane-file-viewer-close").addEventListener("click", function () {
    closeFileViewer();
  });

  // Fullscreen toggle
  document.querySelector(".pane-file-viewer-fullscreen").addEventListener("click", function () {
  ...
  // Copy button
  document.querySelector(".pane-file-viewer-copy").addEventListener("click", function () {
    if (currentContent) copyToClipboard(currentContent);
  });

  // Markdown render toggle
  document.querySelector(".pane-file-viewer-render").addEventListener("click", function () {
  ...
  // PDF export button
  document.querySelector(".pane-file-viewer-pdf").addEventListener("click", function () {
    if (!isRendered || !currentIsMarkdown) return;
    var mdEl = document.querySelector(".file-viewer-markdown");
    if (!mdEl) return;
    var btn = document.querySelector(".pane-file-viewer-pdf");
    btn.disabled = true;
  ...
  // History button
  document.querySelector(".pane-file-viewer-history").addEventListener("click", function () {
...
var _primary = null;
export function initFileBrowser(_ctx) { _primary = createFileBrowserInstance(_ctx); }
export function closeFileViewer() { return _primary.closeFileViewer(); }
export function resetFileBrowser() { return _primary.resetFileBrowser(); }
export function openFile(filePath, opts) { return _primary.openFile(filePath, opts); }
export function loadRootDirectory() { return _primary.loadRootDirectory(); }
export function refreshTree() { return _primary.refreshTree(); }
export function refreshIfOpen(filePath) { return _primary.refreshIfOpen(filePath); }
export function handleFsList(msg) { return _primary.handleFsList(msg); }
export function handleDirChanged(msg) { return _primary.handleDirChanged(msg); }
export function handleFsRead(msg) { return _primary.handleFsRead(msg); }
export function handleFileChanged(msg) { return _primary.handleFileChanged(msg); }
export function handleFileHistory(msg) { return _primary.handleFileHistory(msg); }
export function handleGitDiff(msg) { return _primary.handleGitDiff(msg); }
export function handleFileAt(msg) { return _primary.handleFileAt(msg); }
export function getPendingNavigate() { return _primary.getPendingNavigate(); }
