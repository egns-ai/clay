...
export function createTerminalInstance(_ctx) {
  ...
  // Close panel button
  document.querySelector(".pane-terminal-close").addEventListener("click", function () {
    closeTerminal();
  });

  // Fullscreen toggle
  document.querySelector(".pane-terminal-fullscreen").addEventListener("click", function () {
  ...
  var toggleBtn = document.querySelector(".pane-terminal-toggle-btn");
  if (toggleBtn) {
  ...
  // New tab button
  var newTabBtn = document.querySelector(".pane-terminal-new-tab");
  if (newTabBtn) {
  ...
  function closeTerminal() {
    ...
    // Hide toolbar
    var toolbar = document.querySelector(".pane-terminal-toolbar");
    if (toolbar) {
  ...
  function renderTabBar() {
    var tabsEl = document.querySelector(".pane-terminal-tabs");
    if (!tabsEl) return;
  ...
  function updateTerminalBadge() {
    var countEl = document.querySelector(".pane-terminal-count");
