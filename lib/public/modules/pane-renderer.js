...
function createPaneRenderer(ctx) {
  ...
  // Document click listener cleanup tracking
  var docClickCleanups = [];
  ...
  function addCopyHandler(msgEl, rawText) {
    ...
    docClickCleanups.push(function () { document.removeEventListener("click", docHandler); });
  }
  ...
  function resetClientState() {
    // Clean up document-level click listeners from addCopyHandler
    for (var ci = 0; ci < docClickCleanups.length; ci++) docClickCleanups[ci]();
    docClickCleanups = [];
