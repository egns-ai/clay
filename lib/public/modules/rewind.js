...
export function createRewindInstance(_ctx) {
  ...
  function isRewindMode() {
    return rewindMode;
  }

  function getPendingRewindUuid() {
    return pendingRewindUuid;
  }

  function clearPendingRewindUuid() {
  ...
  function buildRewindTimeline() {
    ...
    var appEl = ctx.$("app");
    var titleBarEl = ctx.paneEl ? ctx.paneEl.querySelector(".title-bar-content") : null;
  ...
  function removeRewindTimeline() {
    if (rewindTimelineEl) { rewindTimelineEl.remove(); rewindTimelineEl = null; }
  ...
  function addRewindButton(msgEl) {
  ...
  return {
    ...
    getPendingRewindUuid: getPendingRewindUuid,
    clearPendingRewindUuid: clearPendingRewindUuid,
    showRewindModal: showRewindModal,
    hideRewindModal: hideRewindModal,
    renderDiffPre: renderDiffPre,
    addRewindButton: addRewindButton
  };
}

// Backward-compatible singleton delegates
var _primary = null;
export function initRewind(_ctx) { _primary = createRewindInstance(_ctx); }
export function setRewindMode(on) { return _primary.setRewindMode(on); }
export function isRewindMode() { return _primary.isRewindMode(); }
export function getPendingRewindUuid() { return _primary.getPendingRewindUuid(); }
export function clearPendingRewindUuid() { return _primary.clearPendingRewindUuid(); }
export function showRewindModal(data) { return _primary.showRewindModal(data); }
export function hideRewindModal() { return _primary.hideRewindModal(); }
export function renderDiffPre(text) { return _primary.renderDiffPre(text); }
export function addRewindButton(msgEl) { return _primary.addRewindButton(msgEl); }
